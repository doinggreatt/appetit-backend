...
from apps.orders.models import OrderStatus, Order, OrderFood, OrderFoodSize, OrderModifierOption
...
config.set_main_option("sqlalchemy.url", db_settings.DATABASE_URI_asyncpg + "?async_fallback=True")
