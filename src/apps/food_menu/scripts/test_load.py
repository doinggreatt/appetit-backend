#!/usr/bin/env python3
"""
Test script to verify the menu loading functionality
"""
...
def test_load():
    """Test the menu loading functionality"""
    print("Testing menu loading...")
    
    try:
        # Load the menu data (preserving existing modifiers)
        loader = MenuJsonLoader()
        loader.load(clear_all=False)
        ...
        session.close()
        print("\n🎉 All tests passed! Menu data loaded successfully.")
